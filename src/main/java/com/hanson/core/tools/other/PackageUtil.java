package com.hanson.core.tools.other;
...
import com.hanson.core.annotation.SecurityMapping;
import com.hanson.view.admin.controller.AdminController;
...
public class PackageUtil {
	...
	public static void main(String[] args) {
		...
		String packageName = AdminController.class.getPackage().getName();
		findPackageClass("com.hanson.view");
		Set<Method> methods = PackageUtil.findClassAnnotationMethods("com.hanson.view", SecurityMapping.class);
        for(Method method : methods){
